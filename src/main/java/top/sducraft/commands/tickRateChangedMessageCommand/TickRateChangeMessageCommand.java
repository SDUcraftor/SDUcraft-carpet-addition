                ...
                .then(argument("string", StringArgumentType.greedyString())
                        .executes((commandContext) -> {
                            ...
                            if (Objects.equals(TickRateChangeMessageCommandHelper.tickRateChangeMessage, "clear")) {
                                ...
                                commandContext.getSource().sendSuccess(() -> translateComponent("sducarpet.easycommand.tickRateChangeMessageCommand1"), true);
                            } else {
                                commandContext.getSource().sendSuccess(() -> translateComponent("sducarpet.easycommand.tickRateChangeMessageCommand2").append(" " + StringArgumentType.getString(commandContext, "string")), true);
                            }
                            return 1;
                        })));
    }
